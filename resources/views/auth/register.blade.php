...
<main class="form-signin w-100 m-auto">
  <form action="{{route('register-post')}}" method="post">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="name@example.com" name="birth_place">
      <label for="floatingInput">Tempat Lahir</label>
    </div>
    <div class="form-floating">
      <input type="date" class="form-control" id="floatingInput" placeholder="name@example.com" name="birth_date">
